...
<div class="container" style="background: #ffffff;">
    <div id="course-container" class="col-xs-12">
        ...
        <div class="col-xs-9">             
            ...
            <form action="<?php echo Yii::app()->request->baseUrl.'/admin/updateCourseDetails?id=' . $model['id'];?>" method="POST"  enctype="multipart/form-data">               
                    <div class="row">
                        <div class="col-xs-12">
                    ...
                    <div id="form-Div" class="row">
                        ...
                        <div class="col-xs-12">
                            <select required name="Coursedetails[courseId]" class="form-control" >
                                ...
                                <option value="<?php echo $value['id']?>" <?php if(isset($model->courseId) && ($model->courseId==$value['id'])) { ?> selected <?php } ?>><?php echo $value['courseName']?></option>                                
                                <?php } }?>
                            </select>
                        </div>
                    </div>
                <br>
                    <div id="form-Div" class="row">
                        ...
                        <div class="col-xs-12">
                            <input  name="Coursedetails[title]"  required class="form-control" placeholder="Title" value="<?php echo $model->title; ?>"/>
                        </div>
                    </div>
                <br>
                <div id="form-Div" class="row">
                    ...
                    <div class="col-xs-12">
                        <input  name="Coursedetails[courseEngVideoLink]" class="form-control" value="<?php echo $model->courseEngVideoLink; ?>" placeholder="Example : https://www.youtube.com/QOrVotzBNto"/>
                    </div>
                </div>
                <br>
                <div id="form-Div" class="row">
                    ...
                    <div class="col-xs-12"> 
                        ...
                        <div class="col-xs-6"><span name="courseEngPDF"> <?php echo $model->courseEngPDF;?></span></div>
                    </div>
                ...
                <div id="form-Div" class="row">
                    ...
                    <div class="col-xs-12">
                        <input name="Coursedetails[courseHindiVideoLink]" class="form-control"  value="<?php echo $model->courseHindiVideoLink;?>" placeholder="Example : https://www.youtube.com/QOrVotzBNto"/>
                    </div>
                ...
                <div id="form-Div" class="row">
                    ...
                    <div class="col-xs-12"> 
                        ...
                        <div class="col-xs-6"><span name="courseHindiPDF"> <?php echo $model->courseHindiPDF;?></span></div>
                    </div>
                ...
                <div id="form-Div" class="row">
                    ...
                    <div class="col-xs-12">
                        <input name="Coursedetails[courseTeluguVideoLink]" class="form-control" value="<?php echo $model->courseTeluguVideoLink;?>" placeholder="Example : https://www.youtube.com/QOrVotzBNto"/>
                    </div>
                 ...
                 <div id="form-Div" class="row">
                    <div class="col-xs-12">
                     ...
                     <div class="col-xs-12"> 
                        ...
                        <div class="col-xs-6"><span name="courseTeluguPDF"> <?php echo $model->courseTeluguPDF;?></span></div>
                    </div>
                ...
                <br>
                  <div id="form-Div" class="row">
                        ...
                        <div class="col-xs-12">
                            <input name="Coursedetails[order_by]" type="number" class="form-control" value="<?php echo $model->order_by;?>" required min="1"/>
                        </div>
                    </div>                    
                    <br>
                    <div id="form-Div" class="row">
