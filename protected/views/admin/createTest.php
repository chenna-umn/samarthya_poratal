...
<div class="container" style="background: #ffffff;">
    <div id="course-container" class="col-xs-12">
        ...
        <div class="col-xs-9">             
            ...
            <form action="<?php echo Yii::app()->request->baseUrl.'/admin/createTest';?>" method="POST"  enctype="multipart/form-data">               
                    <div class="row">
                        <div class="col-xs-12">
                    ...
                    <div id="form-Div" class="row">
                        ...
                        <div class="col-xs-12">
                            <input  name="Tests[test_name]"  required class="form-control" placeholder="Test Name"/>
                        </div>
                    </div>                    
