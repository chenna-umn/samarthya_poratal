    ...
    <div id="course-container" class="col-xs-12">
        ...
        <div class="col-xs-12"> 
            <div class="row">
                ...
                <div class="col-xs-4">
                    <!--<a id="courseBttn" class="btn btn-primary pull-right" href="<?php echo Yii::app()->request->baseUrl . '/admin/CreateAssignTest'; ?>" >Assign Test To Course</a>-->
                </div>
            </div>
                        ...
                        <table class="table table-responsiv table-bordered">
                            <thead>
                                <tr>
                                    <th>
                                        ...
                                        <select required name="Assigntests[course_id]" class="form-control" onchange="searchBy(this.value);">
                                    ...
                                    <th>
                                        ...
                                        <select required name="Assigntests[test_id]" class="form-control" onchange="searchByTest(this.value);">
                                            <option value="All" selected <?php if(isset($testId) && ($testId=="All")) {?> selected <?php } ?>>All Tests</option>
                            ...
                            <tbody>
                                ...
                                if (isset($models) && !empty($models)) {
                                    ...
                                    foreach ($models as $model) {
                                        ...
                                        <tr id="record<?php echo $model['id']; ?>" <?php if(($i%2)==0) { ?>class="info" <?php } ?>>
                                            ...
                                            <td>
                                                <?php echo $model['total_questions']; ?>
                                            </td>
                                            <td>
                                                <?php echo $model['total_marks']; ?>  
                                            </td>
                                            <td>
                                                <?php echo $model['pass_marks']; ?>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="<?php echo Yii::app()->request->baseUrl . '/admin/updateAssignTest?id=' . $model['id']; ?>" target="_blank"><img src="<?php echo Yii::app()->request->baseUrl . '/sm_assets/'; ?>assets/images/edit-icon.png"><span class="edit-txt">Edit</span></button></a>
                                            </td>
                                            <td>
                                ...
                                <div class="alert alert-info fade in">
                                    <strong>Oops!</strong> Currently there are no Tests Assigned.
                                </div>
                            <?php }
                            ?>
...
<script>
    ...
    function deleteRecord(recordId){
        ...
        if (message == true) {                   
            jQuery.ajax({                            
                url: baseurl+'/admin/deleteAssignTest',
                type: "POST",
                data: {id: recordId},  
                error: function(){
    ...
    function makeStatusRecord(recordId,status){
        ...
        if (message == true) {                   
            jQuery.ajax({                            
                url: baseurl+'/admin/MakeStatusAssignTest',
                type: "POST",
                data: {id: recordId},  
                error: function(){
                    alert("Something Went Wrong...Please Try Later.");
    ...
    function searchBy(id){
            var baseurl = "<?php echo Yii::app()->request->baseUrl;?>"; 
            var url = baseurl+'/Admin/SearchByCourseForAssign?id='+id;
            window.location = url;
            window.location.replace (url);
            
        }
        function searchByTest(id){
            var baseurl = "<?php echo Yii::app()->request->baseUrl;?>"; 
            var url = baseurl+'/Admin/SearchByTestForAssign?id='+id;
            window.location = url;
            window.location.replace (url);
