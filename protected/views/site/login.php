<form class="form-horizontal" action="<?php echo Yii::app()->request->baseUrl . '/site/login'; ?>" method="post">
    ...
    <fieldset>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="input-group space">
                    <a href="javascript:void(0);" data-toggle="modal" data-target="#myModal">Sign Up</a>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="input-group space login-btn">
                    <a href="javascript:void(0);" data-toggle="modal" data-target="#myModal1">Forgot Password?</a>
                </div>
            </div>
        </div>
    </fieldset>
